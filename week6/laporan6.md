...
## Bukti
- **POST:** ![POST Request Frame](../assets/image/week6/6.3.png)  
...
## Bukti
- **POST:** ![POST Request Frame](../assets/image/week6/6.4POST.png)
- **SYN:** ![SYN Frame](../assets/image/week6/6.4SYN.png)
- **SYNACK:** ![SYN-ACK Frame](../assets/image/week6/6.4SYNACK.png)
- **TCP:** ![TCP Segment](../assets/image/week6/6.4TCP.png)
- **Relative Sequence:** ![Relative Sequence Numbers](../assets/image/week6/6.4Relative.png)
...
## Bukti
- **Time-Sequence-Graph:** ![Time-Sequence-Graph Stevens](../assets/image/week6/Time-Sequence-Graph.jpeg)  